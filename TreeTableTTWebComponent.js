(function() {
    ...
    function loadthis(that) {
        ...
        div.slot = "content_" + widgetName;
            ...
            div0.innerHTML = '<?xml version="1.0"?><script id="oView_' + widgetName + '" name="oView_' + widgetName + '" type="sapui5/xmlview"><mvc:View id="graph_' + widgetName + '" controllerName="myView.Template" xmlns="sap.ui.table" xmlns:mvc="sap.ui.core.mvc" xmlns:m="sap.m" xmlns:l="sap.ui.layout" height="100%" displayBlock="true"> <TreeTable visibleRowCountMode="Fixed" visibleRowCount="20" rows="{' + widgetName + '>/Transfers}" selectionMode="None" enableSelectAll="false"> <columns><Column width="30%"><m:Label text="Batch"/><template><m:Text text="{'+ widgetName +'>Batch}"/></template></Column><Column width="15%"><m:Label text="Material Description"/><template><m:Text text="{'+ widgetName +'>MaterialDesc}"/></template></Column><Column width="5%"><m:Label text="MatNr."/><template><m:Text text="{'+ widgetName +'>MaterialNr}"/></template></Column><Column width="10%"><m:Label text="Unit"/><template><m:Text text="{'+ widgetName +'>Unit}"/></template></Column><Column width="5%"><m:Label text="Quantity"/><template><m:Text text="{'+ widgetName +'>QTY}"/></template></Column><Column width="5%"><m:Label text="UOM"/><template><m:Text text="{'+ widgetName +'>UOM}"/></template></Column><Column width="15%"><m:Label text="Transfer-Start"/><template><m:Text text="{'+ widgetName +'>TransferEnd}"/></template></Column><Column width="15%"><m:Label text="Transfer-End"/><template><m:Text text="{'+ widgetName +'>TransferStart}"/></template></Column></columns> </TreeTable> </mvc:View></script>';
            //Create SAPUI5 Element
