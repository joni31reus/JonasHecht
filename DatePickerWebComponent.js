(function() {
    ...
    customElements.define("sac-date-picker", DatePicker);

    // UTILS
    function loadthis(that, changedProperties) {
        var that_ = that;

        widgetName = "cw_datePicker";
        ...
        if (that._firstConnection === 0) {
            ...
            div0.innerHTML = '<?xml version="1.0"?><script id="oView_' + widgetName + '" name="oView_' + widgetName + '" type="sapui5/xmlview"><mvc:View id="graph_' + widgetName + '" controllerName="myView.Template" xmlns="sap.m" xmlns:mvc="sap.ui.core.mvc" xmlns:l="sap.ui.layout" ><DatePicker placeholder="Enter Date"/></mvc:View></script>';
            //Create SAPUI5 Element
