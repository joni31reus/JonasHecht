(function() {
    ...
    function loadthis(that) {
        ...
        if (that._firstConnection === 0) {
            ...
            div0.innerHTML = '<?xml version="1.0"?><script id="oView_' + widgetName + '" name="oView_' + widgetName + '" type="sapui5/xmlview"><mvc:View id="graph_' + widgetName + '" controllerName="myView.Template" xmlns="sap.ui.table" xmlns:mvc="sap.ui.core.mvc" xmlns:m="sap.m" xmlns:l="sap.ui.layout" height="100%" displayBlock="true"> <TreeTable rows="{' + widgetName + '>/transfers}" selectionMode="None" enableSelectAll="false"> <columns><Column><m:Label text="Batch"/><template><m:Text text="{'+ widgetName +'>Batchname}"/></template></Column><Column><m:Label text="Unit"/><template><m:Text text="{'+ widgetName +'>Unit}"/></template></Column><Column><m:Label text="Materialnumber"/><template><m:Text text="{'+ widgetName +'>MatNr}"/></template></Column><Column><m:Label text="Material"/><template><m:Text text="{'+ widgetName +'>Material}"/></template></Column><Column><m:Label text="Quantity"/><template><m:Text text="{'+ widgetName +'>QTY}  {'+widgetName +'>UOM}"/></template></Column><Column><m:Label text="Transfer-Start"/><template><m:Text text="{'+ widgetName +'>StartTransfer}"/></template></Column><Column><m:Label text="EndTransfer"/><template><m:Text text="{'+ widgetName +'>EndTransfer}"/></template></Column></columns> </TreeTable> </mvc:View></script>';
            //Create SAPUI5 Element
